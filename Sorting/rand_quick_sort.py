...
In this version of quicksort, the pivot element is selected at random 
then swapped with last element (to be easily extended from the last element pivot version of quicksort)
"""
def partition(arr, p, r):
    # swap arr[r] with a random element
